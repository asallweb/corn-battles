(() => {
    ...
    function initSliders() {
        if (document.querySelector(".mySwiper") && document.querySelector(".mySwiper2")) {
            var thumbSwiper = new swiper_core_Swiper(".mySwiper", {
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        const tickerContent = document.querySelector(".section-1__ticker-content");
        const tickerItems = Array.from(tickerContent.children);
        const totalWidth = tickerItems.reduce(((acc, item) => acc + item.offsetWidth), 0);
